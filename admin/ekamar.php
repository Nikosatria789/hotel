...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "UPDATE kamar SET tipe_kamar = '$tipe_kamar', deskripsi = '$deskripsi', harga = '$harga', status = '$status', gambar = '$gambar_path' WHERE id = $id";
...
<div class="main-content">
    ...
    <div class="card p-6">
    <h2 class="text-2xl font-semibold text-gray-700 mb-8">Edit Kamar</h2>
    <form action="" method="POST" enctype="multipart/form-data">
        <div class="mb-4">
            <label for="tipe_kamar" class="block">Tipe Kamar</label>
            <input type="text" name="tipe_kamar" id="tipe_kamar" class="w-full p-2 border border-gray-300 rounded" value="<?php echo $row['tipe_kamar']; ?>" required>
        </div>

        <div class="mb-4">
            <label for="deskripsi" class="block">Deskripsi</label>
            <textarea name="deskripsi" id="deskripsi" class="w-full p-2 border border-gray-300 rounded" required><?php echo $row['deskripsi']; ?></textarea>
        </div>

        <div class="mb-4">
            <label for="harga" class="block">Harga</label>
            <input type="number" name="harga" id="harga" class="w-full p-2 border border-gray-300 rounded" value="<?php echo $row['harga']; ?>" required>
        </div>
        ...
        <div class="mb-4">
            ...
            <img src="uploads/<?php echo $row['gambar']; ?>" alt="Gambar Kamar" class="mt-2 w-32 h-32 object-cover">
        </div>

        <button type="submit" class="bg-blue-500 text-white py-2 px-4 rounded">Update Kamar</button>
    </form>
