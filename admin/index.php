...
$sql = "SELECT id_user, username, email FROM login"; // Misalnya, Anda punya tabel 'users' dengan kolom 'id', 'nama', dan 'email'
...
<div class="main-content">
    ...
    <div class="card">
        ...
        <div class="card-body px-4 py-5">
            <h4 class="font-semibold text-2xl text-gray-900">256</h4>
        </div>
...
while ($row = mysqli_fetch_assoc($result)) {
    echo "<tr>";
    echo "<td class='py-2 px-4 text-center'>{$row['id_user']}</td>";  // Menambahkan text-center di sini
    echo "<td class='py-2 px-4 text-center'>{$row['username']}</td>";  // Menambahkan text-center di sini
    echo "<td class='py-2 px-4 text-center'>{$row['email']}</td>";     // Menambahkan text-center di sini
    echo "</tr>";
}
?>
                </tbody>
