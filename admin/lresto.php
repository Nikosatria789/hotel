...
<div class="main-content">
    ...
    <a href="tresto.php" class="bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600">Tambah Kamar</a><br><br>
        ...
        <table class="min-w-full text-left">
            <thead class="bg-gray-100">
                <tr>
                    ...
                    <th class="py-3 px-4 border-b">nama restaurant</th>
    ...
    if (mysqli_num_rows($result) > 0) {
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<td class='py-3 px-4 border-b'>{$row['nama_restoran']}</td>";
            ...
            echo "<td class='py-3 px-4 border-b'>
                    <a href='eresto.php?id={$row['id']}' class='text-blue-600'>Edit</a> | 
