...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $tipe_kamar = mysqli_real_escape_string($koneksi, $_POST['nama_restoran']);
    ...
    if (!in_array($_FILES['gambar']['type'], $allowed_types)) {
        ...
        if (move_uploaded_file($gambar_tmp, $gambar_path)) {
            ...
            $query = "INSERT INTO restaurant (nama_restoran, deskripsi, harga, status, gambar) 
                      VALUES ('$nama_restoran', '$deskripsi', '$harga', '$status', '$gambar')";
            
            if (mysqli_query($koneksi, $query)) {
                header("Location: lresto.php");
                exit;
            } else {
        ...
        <nav class="mt-10">
            ...
            <div class="relative group">
                ...
                <div id="dropdownMenu" class="absolute left-0 mt-2 w-full bg-white text-black rounded-lg shadow-lg opacity-0 transition-opacity z-50">
                    ...
                    <a href="security.php" class="block py-2 px-4 text-gray-700 hover:bg-gray-100">restaurant</a>
                </div>
            </div>
        </nav>
    </div>
...
<div class="main-content">
    <div class="breadcrumb-container">
        <nav class="flex items-center">
            ...
            <span class="text-sm font-medium text-gray-600">Form tambah restoran dan bar</span>
        </nav>
    </div>
    ...
    <div class="mb-4">
        <label for="tipe_kamar" class="block">nama restoran</label>
        <input type="text" name="nama_restoran" id="nama_restoran" class="w-full p-2 border border-gray-300 rounded" required>
    </div>
